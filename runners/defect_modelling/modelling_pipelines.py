...
AVAILABLE_PIPELINES = {
    ...
    "unscaled_featureselected_RFECV_DT_randomforest-3": unscaled_featureselected_RFECV_DT_randomforest_pipeline(3),
    "unscaled_featureselected_RFECV_DT_randomforest_Precision-3": unscaled_featureselected_RFECV_DT_randomforest_Precision_pipeline(3),
    "unscaled_featureselected_RFECV_DT_randomforest-5": unscaled_featureselected_RFECV_DT_randomforest_pipeline(5),
    "unscaled_featureselected_RFECV_DT_randomforest_Precision-5": unscaled_featureselected_RFECV_DT_randomforest_Precision_pipeline(5),
    "unscaled_featureselected_RFECV_DT_randomforest-7": unscaled_featureselected_RFECV_DT_randomforest_pipeline(7),
    "unscaled_featureselected_RFECV_DT_randomforest_Precision-7": unscaled_featureselected_RFECV_DT_randomforest_Precision_pipeline(7),
    "unscaled_featureselected_RFECV_DT_randomforest-9": unscaled_featureselected_RFECV_DT_randomforest_pipeline(9),
    "unscaled_featureselected_RFECV_DT_randomforest_Precision-9": unscaled_featureselected_RFECV_DT_randomforest_Precision_pipeline(9),
